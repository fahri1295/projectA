...
<html lang="en">
  ...
  <head>
    ...
    <title>System Laporan Harian</title>
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="index.html">System Laphar</a>
    ...
    <div class="container">
		<hr></hr>
    <!--  <h1 class="my-4">System Laphar</h1> -->
      ...
      <?php 
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="<?php echo base_url();?>file/images/<?php echo $keg['mst_image_kegiatan'];?>" alt=""></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="#"><?php echo $keg['mst_nama_kegiatan'];?></a>
              </h4>
              <p class="card-text"><?php echo $keg['mst_isi_kegiatan'];?></p>
            </div>
     ...
     <div class="row">
        ...
        <div class="col-lg-6">
          <img class="img-fluid rounded" src="<?php echo base_url();?>assets/images/image-bottom.jpg" alt="">
        </div>
      </div>
      <!-- /.row -->
