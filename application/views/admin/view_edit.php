 <?php echo form_open_multipart('admin/edit/'.$user['mst_id_user']);?>
            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  <label>No NRP</label>
                  <input type="text" class="form-control" id="nrp" name="nrp" value="<?php echo ($this->input->post('nrp') ? $this->input->post('nrp') : $user['mst_NRP']); ?>" placeholder="No NRP">
                </div>
                <div class="form-group">
                  <label>Nama Lengkap</label>
                  <input type="text" class="form-control" id="nama" name="nama" value="<?php echo ($this->input->post('nama') ? $this->input->post('nama') : $user['mst_name_user']); ?>" placeholder="Nama Lengkap">
                </div>
                <div class="form-group">
                  <label>Password</label>
                  <input type="password" class="form-control" id="password" name="password" value="" placeholder="Password" required="required">
                </div>
